...
#网络结构的参数，hidden_size代表隐藏层的神经元个数H，seq_length代表时间步数，这里设置为25，什么作用？？ learning_rate是SGD的步长
...
while True:
  ...
  if p+seq_length+1 >= len(data) or n == 0:
    ...
    #n=0的时候初始化，h0=0，然后p=0代表从头开始，另外一种情况是走到最后了然后从头重新走一遍的时候将h设为0？？？这样子会不会丢失以前跑的很多遍的信息？？
